...
const PostFetchFunctions = require("../../functions/post_fetch_processing");
...
async function* testGeneratorMultiStream() {
    yield {
        candidates: TEST_CANDIDATES,
    };
...
class ChatSessionForTest extends chat_session_1.ChatSession {
}
class ChatSessionPreviewForTest extends chat_session_1.ChatSessionPreview {
}
describe('GenerativeModel startChat', () => {
    it('returns ChatSession when pass no arg', () => {
        const model = new generative_models_1.GenerativeModel({
            model: 'gemini-pro',
            project: PROJECT,
            location: LOCATION,
        ...
        expect(chat).toBeInstanceOf(chat_session_1.ChatSession);
    });
    ...
    it('pass tools to remote endpoint from GenerativeModel constructor', async () => {
        ...
        const fetchResult = Promise.resolve(new Response(JSON.stringify(expectedResult), fetchResponseObj));
        ...
        const expectedBody = '{"contents":[{"role":"user","parts":[{"text":"How are you doing today?"}]},{"role":"user","parts":[{"text":"How are you doing today?"}]}],"tools":[{"googleSearchRetrieval":{"disableAttribution":false}}]}';
    ...
    it('pass system instruction to remote endpoint from GenerativeModel constructor', async () => {
        ...
        const expectedBody = '{"contents":[{"role":"user","parts":[{"text":"How are you doing today?"}]},{"role":"user","parts":[{"text":"How are you doing today?"}]}],"systemInstruction":{"role":"system","parts":[{"text":"system instruction"}]}}';
        await chat.sendMessage(req);
        // @ts-ignore
        const actualBody = fetchSpy.calls.allArgs()[0][1].body;
        expect(actualBody).toEqual(expectedBody, `unit test failed in chat.sendMessage with ${actualBody} not equal to ${expectedBody}`);
    });
...
describe('GenerativeModelPreview startChat', () => {
    it('returns ChatSessionPreview when pass no arg', () => {
        const model = new generative_models_1.GenerativeModelPreview({
            model: 'gemini-pro',
            project: PROJECT,
            location: LOCATION,
            googleAuth: FAKE_GOOGLE_AUTH,
        ...
        const chat = model.startChat();
        expect(chat).toBeInstanceOf(chat_session_1.ChatSessionPreview);
    });
...
describe('GenerativeModel generateContent', () => {
    ...
    let expectedResult;
    beforeEach(() => {
        model = new generative_models_1.GenerativeModel({
            model: 'gemini-pro',
            project: PROJECT,
            location: LOCATION,
            googleAuth: FAKE_GOOGLE_AUTH,
        ...
        const fetchResult = new Response(JSON.stringify(expectedResult), fetchResponseObj);
    ...
    it('gemini-pro model send correct resourcePath to functions', async () => {
        const modelWithShortName = new generative_models_1.GenerativeModel({
            model: 'gemini-pro',
            project: PROJECT,
            location: LOCATION,
            googleAuth: FAKE_GOOGLE_AUTH,
        ...
        const expectedResourcePath = 'projects/test_project/locations/test_location/publishers/google/models/gemini-pro';
        await modelWithShortName.generateContent(req);
        // @ts-ignore
        expect(generateContentSpy.calls.allArgs()[0][1]).toEqual(expectedResourcePath);
    });
    it('models/gemini-pro model send correct resourcePath to functions', async () => {
        const modelWithLongName = new generative_models_1.GenerativeModel({
    ...
    it('projects/my-project/my-tuned-gemini-pro model send correct resourcePath to functions', async () => {
        const modelWithFullName = new generative_models_1.GenerativeModel({
    ...
    it('empty model raise ClientError', () => {
        const expectedErrorMessage = '[VertexAI.ClientError]: model parameter must not be empty.';
        try {
            new generative_models_1.GenerativeModel({
                model: '',
                project: PROJECT,
                location: LOCATION,
                googleAuth: FAKE_GOOGLE_AUTH,
    ...
    it('invalid model raise ClientError', () => {
        const expectedErrorMessage = '[VertexAI.ClientError]: model parameter must be either a Model Garden model ID or a full resource name.';
        try {
            new generative_models_1.GenerativeModel({
    ...
    it('send timeout options to functions', async () => {
        const modelWithRequestOptions = new generative_models_1.GenerativeModel({
            model: 'gemini-pro',
            project: PROJECT,
            location: LOCATION,
            googleAuth: FAKE_GOOGLE_AUTH,
    ...
    it('set system instruction in constructor, should send system instruction to functions', async () => {
        const modelWithSystemInstruction = new generative_models_1.GenerativeModel({
            model: 'gemini-pro',
            project: PROJECT,
            location: LOCATION,
            googleAuth: FAKE_GOOGLE_AUTH,
    ...
    it('pass tools to remote endpoint when tools are passed via constructor', async () => {
        ...
        const expectedBody = '{"contents":[{"role":"user","parts":[{"text":"How are you doing today?"}]}],"tools":[{"functionDeclarations":[{"name":"get_current_weather","description":"get weather in a given location","parameters":{"type":"OBJECT","properties":{"location":{"type":"STRING"},"unit":{"type":"STRING","enum":["celsius","fahrenheit"]}},"required":["location"]}}]}]}';
    ...
    it('pass tools to remote endpoint when tools are passed via generateContent', async () => {
        ...
        const expectedBody = '{"contents":[{"role":"user","parts":[{"text":"What is the weater like in Boston?"}]}],"tools":[{"googleSearchRetrieval":{"disableAttribution":false}}]}';
        await model.generateContent(req);
        // @ts-ignore
        const actualBody = fetchSpy.calls.allArgs()[0][1].body;
        expect(actualBody).toEqual(expectedBody);
...
describe('GenerativeModelPreview generateContent', () => {
    ...
    let expectedResult;
    beforeEach(() => {
        model = new generative_models_1.GenerativeModelPreview({
            model: 'gemini-pro',
            project: PROJECT,
            location: LOCATION,
            googleAuth: FAKE_GOOGLE_AUTH,
    ...
    it('gemini-pro model send correct resourcePath to functions', async () => {
        const modelWithShortName = new generative_models_1.GenerativeModelPreview({
            model: 'gemini-pro',
            project: PROJECT,
            location: LOCATION,
            googleAuth: FAKE_GOOGLE_AUTH,
    ...
    it('models/gemini-pro model send correct resourcePath to functions', async () => {
        const modelWithLongName = new generative_models_1.GenerativeModelPreview({
            model: 'models/gemini-pro',
            project: PROJECT,
            location: LOCATION,
            googleAuth: FAKE_GOOGLE_AUTH,
    ...
    it('projects/my-project/my-tuned-gemini-pro model send correct resourcePath to functions', async () => {
        const modelWithFullName = new generative_models_1.GenerativeModelPreview({
            model: 'projects/my-project/my-tuned-gemini-pro',
            project: PROJECT,
            location: LOCATION,
            googleAuth: FAKE_GOOGLE_AUTH,
    ...
    it('empty model raise ClientError', () => {
        const expectedErrorMessage = '[VertexAI.ClientError]: model parameter must not be empty.';
        try {
            new generative_models_1.GenerativeModelPreview({
                model: '',
                project: PROJECT,
                location: LOCATION,
                googleAuth: FAKE_GOOGLE_AUTH,
    ...
    it('send timeout options to functions', async () => {
        const modelWithRequestOptions = new generative_models_1.GenerativeModelPreview({
            model: 'gemini-pro',
            project: PROJECT,
            location: LOCATION,
            googleAuth: FAKE_GOOGLE_AUTH,
    ...
    it('set system instruction in constructor, should send system instruction to functions', async () => {
        const modelWithSystemInstruction = new generative_models_1.GenerativeModelPreview({
            model: 'gemini-pro',
            project: PROJECT,
            location: LOCATION,
            googleAuth: FAKE_GOOGLE_AUTH,
...
describe('GenerativeModel generateContentStream', () => {
    ...
    it('returns a GenerateContentResponse when passed text content', async () => {
        const req = { contents: TEST_USER_CHAT_MESSAGE };
        const expectedResult = {
            response: Promise.resolve(TEST_MODEL_RESPONSE),
        ...
        expect(Date.now() - firstChunkTimestamp).toBeGreaterThanOrEqual(200 - DATE_NOW_PRECISION_MILLIS);
    });
    it('gemini-pro model send correct resourcePath to functions', async () => {
        const modelWithShortName = new generative_models_1.GenerativeModel({
            model: 'gemini-pro',
    ...
    it('returns a FunctionCall when passed a FunctionDeclaration', async () => {
        ...
        spyOn(PostFetchFunctions, 'processStream').and.resolveTo(expectedStreamResult);
        const resp = await model.generateContentStream(req);
...
describe('ChatSession', () => {
    ...
    describe('sendMessage', () => {
        ...
        const fetchResult = Promise.resolve(new Response(JSON.stringify(expectedResponse), fetchResponseObj));
        beforeEach(() => {
        ...
        it('gemini-pro model send correct resourcePath to functions', async () => {
            ...
            const generateContentSpy = spyOn(GenerateContentFunctions, 'generateContent').and.callThrough();
            const expectedResult = {
                response: TEST_MODEL_RESPONSE,
            };
            spyOn(PostFetchFunctions, 'processUnary').and.resolveTo(expectedResult);
        ...
        it('send timeout to functions', async () => {
            ...
            const req = 'How are you doing today?';
            const generateContentSpy = spyOn(GenerateContentFunctions, 'generateContent').and.resolveTo({
                response: TEST_MODEL_RESPONSE,
            });
            await chatSessionWithRequestOptions.sendMessage(req);
            expect(chatSessionWithRequestOptions.requestOptions).toEqual(TEST_REQUEST_OPTIONS);
            expect(generateContentSpy.calls.allArgs()[0][8].timeout).toEqual(0);
        });
        ...
        it('returns a FunctionCall and appends to history when passed a FunctionDeclaration', async () => {
            ...
            expect((await chatSessionWithFunctionCall.getHistory()).length).toEqual(2);
            ...
            expect((await chatSessionWithFunctionCall.getHistory()).length).toEqual(4);
        });
    ...
    describe('sendMessageStream', () => {
        ...
        it('returns a StreamGenerateContentResponse and appends to history', async () => {
            ...
            expect(history[0].role).toEqual(util_1.constants.USER_ROLE);
            ...
            expect(secondHistory[0].role).toEqual(util_1.constants.USER_ROLE);
            expect(secondHistory[1].role).toEqual(util_1.constants.USER_ROLE);
            expect(secondHistory[2].role).toEqual(util_1.constants.MODEL_ROLE);
        });
        ...
        it('gemini-pro model send correct resourcePath to functions', async () => {
            ...
            const chatSessionWithShortName = modelWithShortName.startChat();
            const req = TEST_CHAT_MESSSAGE_TEXT;
            const generateContentSpy = spyOn(GenerateContentFunctions, 'generateContentStream').and.callThrough();
            const expectedResult = {
                response: Promise.resolve(TEST_MODEL_RESPONSE),
                stream: testGeneratorMultiStream(),
            };
        ...
        it('send timeout to functions', async () => {
            ...
            const req = 'How are you doing today?';
            const generateContentSpy = spyOn(GenerateContentFunctions, 'generateContentStream').and.resolveTo({
                response: Promise.resolve(TEST_MODEL_RESPONSE),
                stream: testGenerator(),
            });
