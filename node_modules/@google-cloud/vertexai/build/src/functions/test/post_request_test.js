...
describe('postRequest', () => {
    ...
    it('apiClient header contains line break type 1, should throw', async () => {
        ...
        const expectedErrorMessage = '[VertexAI.ClientError]: Found line break in apiClient request option field, please remove ' +
            'the line break and try again.';
        await (0, post_request_1.postRequest)({
            region: REGION,
    ...
    it('customer object header contains line break type 1, should throw', async () => {
        ...
        const expectedErrorMessage = '[VertexAI.ClientError]: Found line break in customerHeaders request option field, please remove ' +
            'the line break and try again.';
        await (0, post_request_1.postRequest)({
            region: REGION,
            resourcePath: RESOURCE_PATH,
    ...
    it('set both custom header and apiClient, should prioritize apiClient and SDK headers if sent to internal endpoint', async () => {
        ...
        const actualHeaders = fetchSpy.calls.mostRecent().args[1].headers;
        expect(actualHeaders.get('X-Goog-Api-Client')).toEqual('apiClient1, apiClient2');
...
//# sourceMappingURL=post_request_test.js.map