import { FlowStateStore, FlowState, FlowStateQuery, FlowStateQueryResponse } from './flowTypes.mjs';
import 'zod';
 ...
 */
declare class LocalFileFlowStateStore implements FlowStateStore {
...
export { LocalFileFlowStateStore };
