...
__export(gemini_exports, {
  ...
  gemini15FlashPreview: () => gemini15FlashPreview,
  gemini15ProPreview: () => gemini15ProPreview,
...
const SafetySettingsSchema = import_zod.z.object({
  category: import_zod.z.nativeEnum(import_vertexai.HarmCategory),
  threshold: import_zod.z.nativeEnum(import_vertexai.HarmBlockThreshold)
});
const GeminiConfigSchema = import_model.GenerationCommonConfigSchema.extend({
  safetySettings: import_zod.z.array(SafetySettingsSchema).optional()
});
...
const gemini15ProPreview = (0, import_model.modelRef)({
...
const gemini15FlashPreview = (0, import_model.modelRef)({
  ...
  return (0, import_model.defineModel)(
    ...
    (request, streamingCallback) => __async(this, null, function* () {
      ...
      const client = vertex.preview.getGenerativeModel(
        ...
        {
          apiClient: import_core.GENKIT_CLIENT_HEADER
        }
      );
