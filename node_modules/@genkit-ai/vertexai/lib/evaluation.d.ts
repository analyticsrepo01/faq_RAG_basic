...
type VertexAIEvaluationMetric = VertexAIEvaluationMetricType | VertexAIEvaluationMetricConfig;
declare function vertexEvaluators(auth: GoogleAuth, metrics: VertexAIEvaluationMetric[], projectId: string, location: string): Action[];

export { type VertexAIEvaluationMetric, type VertexAIEvaluationMetricConfig, VertexAIEvaluationMetricType, vertexEvaluators };
