...
function conformOutput() {
  return (req, next) => __async(this, null, function* () {
    ...
    if (!((_a = req.output) == null ? void 0 : _a.schema) || ((_b = req.messages.at(-1)) == null ? void 0 : _b.content.some((part) => {
      var _a2;
      return ((_a2 = part.metadata) == null ? void 0 : _a2.purpose) === "output";
    }))) {
      return next(req);
    }
...
function augmentWithContext(options) {
  ...
  return (req, next) => {
    ...
    if (!userMessage)
      return next(req);
    if (userMessage == null ? void 0 : userMessage.content.find((p) => {
      var _a2;
      return ((_a2 = p.metadata) == null ? void 0 : _a2.purpose) === "context";
    }))
      return next(req);
    let out = `${preface || ""}`;
    (_b = req.context) == null ? void 0 : _b.forEach((d, i) => {
