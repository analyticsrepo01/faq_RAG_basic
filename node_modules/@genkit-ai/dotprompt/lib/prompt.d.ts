...
type PromptGenerateOptions<V = unknown> = Omit<GenerateOptions<z.ZodTypeAny, typeof GenerationCommonConfigSchema>, 'prompt' | 'history' | 'model'> & {
    model?: string;
    input?: V;
};
...
export { Dotprompt, type PromptData, type PromptGenerateOptions, defineDotprompt };
