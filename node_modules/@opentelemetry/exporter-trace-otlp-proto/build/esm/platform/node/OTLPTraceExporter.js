...
var OTLPTraceExporter = /** @class */ (function (_super) {
    ...
    function OTLPTraceExporter(config) {
        ...
        _this.headers = __assign(__assign(__assign(__assign({}, _this.headers), USER_AGENT), baggageUtils.parseKeyPairsIntoRecord(getEnv().OTEL_EXPORTER_OTLP_TRACES_HEADERS)), config.headers);
        return _this;
    }
