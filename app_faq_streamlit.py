...
PROJECT_ID = "saib-ai-playground"  # Replace with your project ID
vertexai.init(project=PROJECT_ID, location="us-central1")
data_store_path =  'projects/288406675721/locations/global/collections/default_collection/dataStores/test-search-datastore_1717727903156' # Replace with your actual data_store_path
...
if uploaded_file:
    ...
    # Vertex AI Search variables
    DATA_STORE_LOCATION = "global"
    DATA_STORE_ID = "document-data-store_1716955406023" 

    # Declare Vertex AI Search Retriever
    VertexAISearch_retriever = VertexAISearchRetriever(
    ...
    ensemble_retriever = EnsembleRetriever(retrievers=[bm25_retriever, faiss_retriever, VertexAISearch_retriever], weights=[1/3,1/3,1/3])
